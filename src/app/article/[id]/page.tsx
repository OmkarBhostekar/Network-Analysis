        ...
        <>
            ...
            <div className="my-card grid grid-cols-1 md:grid-cols-2 m-8 gap-4">
                <div className="shadow-sm dark:text-white rounded-md items-center">
                    ...
                    <p className="text-2xl dark:text-gray-200 text-gray-700 text-center">
                        Tweet Frequencies, tweet content, tweet topics, tweet
                        timing, and tweet networks are some of the factors to
                        decide whether the author of the tweet is a real or
                        fake.
                    </p>
                </div>
            ...
            <div className="my-card grid grid-cols-1 md:grid-cols-2 m-8 gap-4">
                ...
                <div className="mt-20">
                    ...
                    <p className="text-2xl dark:text-gray-200 text-gray-700 text-center">
                        Tweet analysis is the process of examining and analyzing
                        the content of tweets on social media platforms.
                    </p>
                </div>
                <div className="shadow-sm dark:text-white rounded-md">
